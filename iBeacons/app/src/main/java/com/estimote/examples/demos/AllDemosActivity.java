...
public class AllDemosActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    */
    findViewById(R.id.show_shop).setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
          Intent intent = new Intent(AllDemosActivity.this, ShopActivity.class);
          intent.putExtra(ShopActivity.EXTRAS_TARGET_ACTIVITY, CharacteristicsDemoActivity.class.getName());
          startActivity(intent);
        }
      });
  }
